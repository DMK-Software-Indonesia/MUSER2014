<?php
/**
 * Skype Extension Ver 2.1a
 * @author Guy Taylor
 * @copyright © 2007 Guy Taylor
 * @link https://www.mediawiki.org/wiki/Extension:Skype
 */
...
$wgExtensionCredits['parserhook'][] = array(
        ...
        'version' => '2.1a',
        'author' => 'Guy Taylor',
        'url' => 'https://www.mediawiki.org/wiki/Extension:Skype',
        'description' => 'Renders a Skype Button showing users online status.'
);
...
// start the rendering the html outupt
     ...
     $output .= '<!-- MediaWiki extension http://www.mediawiki.org/wiki/Extension:Skype -->';
